    ...
    <div id="login-container"
        ...
        <form id="form" class="flex flex-col items-center space-y-5">
            ...
            <div class="field-anim relative w-full">
                ...
                <input placeholder="Nombres" type="text" name="name"
                    class="w-full pl-10 pr-5 py-3 bg-white/50 border border-slate-200 rounded-md focus:ring-4 focus:ring-indigo-200 focus:border-indigo-200
                outline-none transition-all placeholder:text-slate-400">
            </div>
            ...
            <div class="field-anim relative w-full">
                ...
                <input placeholder="Apellidos" type="text" name="last_name"
                    class="w-full pl-10 pr-5 py-3 bg-white/50 border border-slate-200 rounded-md focus:ring-4 focus:ring-indigo-200 focus:border-indigo-200
                outline-none transition-all placeholder:text-slate-400">
            </div>
            ...
            <div class="field-anim relative w-full">
                ...
                <input placeholder="Dirección" type="address" name="address"
                    class="w-full pl-10 pr-5 py-3 bg-white/50 border border-slate-200 rounded-md focus:ring-4 focus:ring-indigo-200 focus:border-indigo-200
                outline-none transition-all placeholder:text-slate-400">
            </div>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (result.status) {
                    ...
                    console.log('error actual: ', result.errors)
                    alert('Error: Mensaje de prueba que el error está acá', result.message)
                }
            } catch (error) {
